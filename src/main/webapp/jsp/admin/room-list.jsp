...
<div class="container-fluid">
    ...
    <h3 class="mb-4">Room Types Management</h3>

    <!-- Filters and Search -->
    <div class="card mb-3">
        <div class="card-body">
            <form method="get" action="${pageContext.request.contextPath}/admin/rooms" class="form-inline">
                <div class="d-flex align-items-center">
                    <!-- Search -->
                    <div class="form-group mr-2 mb-0">
                        <label class="mr-1">Search:</label>
                        <input type="text" name="keyword" class="form-control mr-2" 
                               placeholder="Room type name..." value="${keyword}" style="width: 180px;">
                    </div>

                    <!-- Price Filter -->
                    <div class="form-group mr-2 mb-0">
                        <label class="mr-1">Price:</label>
                        <select name="price" class="form-control mr-2" style="width: 110px;">
                    ...
                    <!-- Capacity Filter -->
                    <div class="form-group mr-2 mb-0">
                        <label class="mr-1">Capacity:</label>
                        <select name="capacity" class="form-control mr-2" style="width: 110px;">
                    ...
                    <div class="form-group mr-2 mb-0">
                        ...
                        <select name="status" class="form-control mr-2" style="width: 110px;">
                    ...
                    <c:if test="${not empty keyword || not empty selectedPrice || not empty selectedCapacity || not empty selectedStatus}">
                        <a href="${pageContext.request.contextPath}/admin/rooms" class="btn btn-secondary ml-2">
                            <i class="fas fa-times"></i> Clear
                        </a>
                    </c:if>
                </div>

                <a href="${pageContext.request.contextPath}/admin/rooms?action=form" class="btn btn-success ml-auto">
