    ...
    <div class="row mb-4">
        ...
        <div class="col-md-3">
            <div class="stat-card">
                ...
                <div class="stat-number">${activeCustomers != null ? activeCustomers : 0}</div>
        ...
        <div class="col-md-3">
            <div class="stat-card">
                ...
                <div class="stat-number">${vipCustomers != null ? vipCustomers : 0}</div>
        ...
        <div class="col-md-3">
            <div class="stat-card">
                ...
                <div class="stat-number">${newCustomersThisMonth != null ? newCustomersThisMonth : 0}</div>
                        ...
                        <c:when test="${not empty customers}">
                            <c:forEach var="customer" items="${customers}" varStatus="status">
                                <tr>
                                    ...
                                    <td>
                                        <a href="${pageContext.request.contextPath}/receptionist/customers?action=view&id=${customer.id}" 
                                           class="btn btn-sm btn-info" title="View Details">
                                            <i class="fas fa-eye"></i>
                                        </a>
                                        <button class="btn btn-sm btn-primary" onclick="createBookingForCustomer('${customer.id}')"
                                                title="New Booking">
                            ...
                            <tr>
                                <td colspan="7" class="text-center text-muted py-4">
                                    ...
                                    <c:if test="${totalCustomers == 0}">
                                        <br><small>Start by adding your first customer!</small>
                                    </c:if>
                                </td>
                            </tr>
                        </c:otherwise>
...
function createBookingForCustomer(customerId) {
    window.location.href = '${pageContext.request.contextPath}/receptionist/reservations?customerId=' + customerId;
}

function exportCustomers() {
    window.location.href = '${pageContext.request.contextPath}/receptionist/customers?action=exportCustomers';
}
</script>