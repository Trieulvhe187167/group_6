...
<style>
    ...
    /* Add fixed width for all icons to ensure consistency */
    .fas, .far, .fal, .fab {
        width: 1.25em;
        text-align: center;
    }
    ...
    <div class="row mb-4">
        <div class="col-md-3">
            <div class="card border-info">
                <div class="card-body text-center">
                    <i class="fas fa-calendar-check fa-2x fa-fw text-info mb-2"></i>
        ...
        <div class="col-md-3">
            <div class="card border-success">
                <div class="card-body text-center">
                    <i class="fas fa-check-circle fa-2x fa-fw text-success mb-2"></i>
                    <h3 class="mb-1">
        ...
        <div class="col-md-3">
            <div class="card border-warning">
                <div class="card-body text-center">
                    <i class="fas fa-clock fa-2x fa-fw text-warning mb-2"></i>
        ...
        <div class="col-md-3">
            <div class="card border-primary">
                <div class="card-body text-center">
                    <i class="fas fa-bed fa-2x fa-fw text-primary mb-2"></i>
                    ...
                    <div class="input-group input-group-lg">
                        ...
                        <div class="input-group-append">
                            <button class="btn btn-outline-secondary" type="button" onclick="scanQRCode()">
                                <i class="fas fa-qrcode fa-fw"></i> Scan QR
                            </button>
            ...
            <c:choose>
                                        ...
                                        <div class="row align-items-center">
                                            <div class="col-8">
                                                ...
                                                <p class="text-xs mb-1">
                                                    <i class="fas fa-door-open fa-fw mr-1"></i>
                                                ...
                                                <c:choose>
                                                    <c:when test="${reservation.checkedIn}">
                                                        <button class="btn btn-secondary" disabled>
                                                            <i class="fas fa-check fa-fw"></i> Already Checked In
                                                        </button>
                                                    </c:when>
                                                    <c:otherwise>
                                                        <button class="quick-action-btn btn btn-info" 
                                                                onclick="startCheckIn(${reservation.id})">
                                                            <i class="fas fa-user-check fa-fw"></i> Process Check-In
                                                        </button>
                                                    </c:otherwise>
                                                </c:choose>
                                            </div>
                ...
                <c:otherwise>
                    <div class="text-center py-5">
                        ...
                        <p class="text-muted">You can search for reservations using the search function above</p>
                    </div>
                </c:otherwise>
            </c:choose>
        </div>
    ...
    <div class="modal-dialog modal-xl">
        <div class="modal-content">
            <div class="modal-header bg-info text-white">
                ...
                <button type="button" class="close text-white" data-dismiss="modal" onclick="closeCheckInModal()">
                    <span>&times;</span>
                </button>
            </div>
            <form id="checkInForm">
                ...
                <div class="modal-body">
                    ...
                    <div id="step1Content" class="step-content">
                        <div class="row">
                            <div class="col-md-6">
                                <h6 class="mb-3"><i class="fas fa-user fa-fw"></i> Guest Information</h6>
                                ...
                                <div class="id-verification mt-3">
                                    <h6 class="mb-3"><i class="fas fa-id-card fa-fw"></i> ID Verification</h6>
                            ...
                            <div class="col-md-6">
                                <h6 class="mb-3"><i class="fas fa-bed fa-fw"></i> Reservation Details</h6>
                    ...
                    <div id="step2Content" class="step-content" style="display: none;">
                        <div class="row">
                            <div class="col-md-6">
                                <h6 class="mb-3"><i class="fas fa-key fa-fw"></i> Room Assignment</h6>
                            ...
                            <div class="col-md-6">
                                <h6 class="mb-3"><i class="fas fa-bed fa-fw"></i> Room Features</h6>
                    ...
                    <div id="step3Content" class="step-content" style="display: none;">
                        <div class="row">
                            <div class="col-md-6">
                                <h6 class="mb-3"><i class="fas fa-money-check-alt fa-fw"></i> Payment Summary</h6>
                                <div class="table-responsive">
                                    <table class="table table-sm">
                                        <tr>
                                            <td>Room Charges:</td>
...
<!--                                        <tr class="font-weight-bold">
                            ...
                            <div class="col-md-6">
                                <h6 class="mb-3"><i class="fas fa-check-circle fa-fw"></i> Final Checklist</h6>
                                <div class="custom-control custom-checkbox mb-2">
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" class="btn btn-success" id="btnComplete" 
                        ...
                        <i class="fas fa-check-circle fa-fw"></i> Complete Check-In
                    </button>
                    <button type="button" class="btn btn-outline-secondary" data-dismiss="modal" onclick="closeCheckInModal()">Cancel</button>
                </div>
            </form>
        </div>
    </div>
