...
<html lang="en">
    ...
    <head>
        ...
        <!-- PAGE TITLE HERE ============================================= -->
        <title>LexusHotel | Customer Manage </title>
        ...
        <main class="ttr-wrapper">
            <div class="container-fluid">
                <div class="db-breadcrumb">
                    <h4 class="breadcrumb-title">Customer Manager</h4>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-12 m-b30">
                        <div class="widget-box">
                            <div class="wc-title d-flex justify-between align-center">
                                <h4>List of Customer</h4>
                                <a href="#" class="btn button-sm green radius-md btn-large">Add more Customer</a>
                            </div>
                            <div class="widget-inner">
                                <div class="card-courses-list admin-courses">
                                    <div class="card-courses-media">
                                        <img src="/admin/assets/images/courses/pic1.jpg" alt=""/>
                                    </div>
                                    <div class="card-courses-full-dec">
                                        <div class="card-courses-title">
                                            <h4>Become a PHP Master and Make Money</h4>
                                        </div>
                                        <div class="card-courses-list-bx">ffffffffff
                                ...
                                <div class="card-courses-list admin-courses">
                                    <div class="card-courses-media">
                                        <img src="/admin/assets/images/courses/pic2.jpg" alt=""/>
                                    </div>
                                    <div class="card-courses-full-dec">
                                        <div class="card-courses-title">
                                            <h4>Become a PHP Master and Make Money</h4>
                                ...
                                <div class="card-courses-list admin-courses">
                                    <div class="card-courses-media">
                                        <img src="/admin/assets/images/courses/pic3.jpg" alt=""/>
                                    </div>
                                    <div class="card-courses-full-dec">
                                        <div class="card-courses-title">
                                            <h4>Become a PHP Master and Make Money</h4>
                                ...
                                <div class="card-courses-list admin-courses">
                                    <div class="card-courses-media">
                                        <img src="/admin/assets/images/courses/pic4.jpg" alt=""/>
                                    </div>
                                    <div class="card-courses-full-dec">
                                        <div class="card-courses-title">
                                            <h4>Become a PHP Master and Make Money</h4>
