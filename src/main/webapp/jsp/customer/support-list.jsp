    ...
    <body>
        ...
        <div class="dashboard-container">
            ...
            <main class="main-content">
                ...
                <%-- Biến mặc định nếu filter/sort chưa được set --%>
                <c:set var="currentFilter" value="${param.filter != null ? param.filter : 'all'}"/>
                <c:set var="currentSort" value="${param.sort != null ? param.sort : 'date'}"/>
                ...
                <div style="background-color: white; padding: 30px; border-radius: 12px; box-shadow: 0 2px 8px rgba(0,0,0,0.05); margin-bottom: 30px;">
                    <div class="filter-section mb-4">
                        ...
                        <div class="mb-4">
                            ...
                            <div style="display: flex; gap: 10px; flex-wrap: wrap;">
                                <c:forEach var="status" items="${statusList}">
                                    <a href="support?filter=${status}&sort=${currentSort}"
                                       style="padding: 10px 20px;
                                       background: ${currentFilter == status ? '#667eea' : '#f8f9fa'};
                                       color: ${currentFilter == status ? 'white' : '#495057'};
                                       text-decoration: none; border-radius: 8px;
                                       border: 2px solid #e9ecef; font-weight: 500;">
                                        <c:out value="${fn:toUpperCase(fn:substring(status, 0, 1))}${fn:substring(status, 1)}"/>
                                    </a>
                                </c:forEach>
                            </div>
                        </div>
                        ...
                        <div>
                            ...
                            <div style="display: flex; gap: 10px; flex-wrap: wrap;">
                                <c:forEach var="sortOption" items="${['date', 'title']}">
                                    <a href="support?sort=${sortOption}&filter=${currentFilter}"
                                       style="padding: 10px 20px;
                                       background: ${currentSort == sortOption ? '#667eea' : '#f8f9fa'};
                                       color: ${currentSort == sortOption ? 'white' : '#495057'};
                                       text-decoration: none; border-radius: 8px;
                                       border: 2px solid #e9ecef; font-weight: 500;">
                                        <c:choose>
