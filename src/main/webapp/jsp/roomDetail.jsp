    ...
    <head>
        ...
        <style>
            ...
            .slide img {
                ...
                height: 100%;
                object-fit: cover;
                cursor: zoom-in; /* Thêm con trỏ zoom-in để báo hiệu có thể click */
            }
            .slide.active-slide {
                display: block;
            }
            ...
            .modal-content {
                ...
                max-width: 90%;
                max-height: 90%;
                object-fit: contain; /* Đảm bảo ảnh vừa khung mà không cắt */
            }
                    ...
                    <div class="container">
                                ...
                                <div class="booking-form">
                                    ...
                                    <div class="room-gallery">
                                        ...
                                        <div class="image-gallery-container">
                                                ...
                                                <c:choose>
                                                    <c:when test="${not empty imageUrls}">
                                                        <c:forEach var="imageUrl" items="${imageUrls}" varStatus="loop">
                                                            <div class="slide ${loop.index == 0 ? 'active-slide' : ''}">
                                                                <img src="${imageUrl}" alt="Room Image ${loop.index + 1}" onclick="openModal('${imageUrl}')" />
                                                            </div>
                                                        </c:forEach>
                                                    </c:when>
                                                    <c:otherwise>
                                            ...
                                            <c:if test="${not empty imageUrls}">
                                                <div class="dot-container">
                                                    <c:forEach var="imageUrl" items="${imageUrls}" varStatus="loop">
                                                        <span class="dot ${loop.index == 0 ? 'active-dot' : ''}" onclick="currentSlide(${loop.index + 1})"></span>
                                                    </c:forEach>
                                                </div>
                                            </c:if>
                                        ...
                                        <div id="imageModal" class="modal" onclick="closeModal()">
                                            <span class="close" title="Đóng">&times;</span>
                        ...
                        <script>
                                                                       ...
                                                                       function openModal(imageSrc) {
                                                                           ...
                                                                           modalImg.classList.add('zoomed'); // Add animation class
                                                                       }

                                                                       // Close modal
                                                                       function closeModal() {
                                                                           modal.style.display = "none";
                                                                           modalImg.classList.remove('zoomed'); // Remove class for next animation
                                                                       }
