                        ...
                        <ul>	<!-- SLIDE  -->
                            <li data-index="rs-100" 
                                ...
                                <div class="tp-caption Newspaper-Button rev-btn" 
                                     ...
                                     data-paddingbottom="[12,12,12,12]"
                                     data-paddingleft="[30,35,35,15]"
                                     style="z-index: 8; white-space: nowrap; outline:none;box-shadow:none;box-sizing:border-box;-moz-box-sizing:border-box;-webkit-box-sizing:border-box;cursor:pointer; border-radius:30px;">BOOKING</div>
                            </li>
                            <li data-index="rs-200" 
                                ...
                                <div class="tp-caption Newspaper-Button rev-btn"
                                     ...
                                     data-paddingbottom="[12,12,12,12]"
                                     data-paddingleft="[30,35,35,15]"
                                     style="z-index: 8; white-space: nowrap; outline:none; box-shadow:none; box-sizing:border-box; cursor:pointer;
                        ...
                        <div class="container">
                            <div class="row">
                                <div class="col-md-12 text-center text-white">
                                    <h2>People Online To Booking Room</h2>
                                    <h5></h5>
                                    <form class="cours-search">
                                        <div class="input-group">
                                            <input type="text" class="form-control" placeholder="What do you want Booking?	">
                                ...
                                <div class="row">
                                    <div class="col-md-4 col-sm-6">
                                        <div class="cours-search-bx m-b30">
                                            <div class="icon-box">
                                                <h3><i class="ti-user"></i><span class="counter">100</span></h3>
                                            </div>
                                            <span class="cours-search-text">Over 100 Customer / Day</span>
                                        </div>
                                    </div>
                                    <div class="col-md-4 col-sm-6">
                                        <div class="cours-search-bx m-b30">
                                            <div class="icon-box">
                                                <h3><i class="ti-book"></i><span class="counter">1</span>K</h3>
                                            </div>
                                            <span class="cours-search-text">1000 Room.</span>
                                        </div>
                                    </div>
                                    <div class="col-md-4 col-sm-12">
                                        <div class="cours-search-bx m-b30">
                                            <div class="icon-box">
                                                <h3><i class="ti-layout-list-post"></i><span class="counter">24</span>/24</h3>
                                            </div>
                                            <span class="cours-search-text">Booking every day</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
