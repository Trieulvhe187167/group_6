...
public class AdminUserManagementServlet extends HttpServlet {
    ...
    switch (action) {
        case "/admin/customers":
            listUsersByRole(request, response, "customer");
            break;
        case "/admin/employees":
            listUsersByRole(request, response, "employee");
            break;
        // các chức năng khác
    }
            private void listUsersByRole(HttpServletRequest request, HttpServletResponse response, String role)
        throws ServletException, IOException {
